...
north=pd.read_excel(os.path.join(path1,'location_conference_refined.xlsx'),usecols=['North'])
north=north.to_numpy()
...
yfinal1month= pd.read_excel(r'C:\Users\DELL\Desktop\SOP\sample1_conference.xlsx')
...
plt.title('Temporal Pattern(N)', fontsize=16)
plt.show()
...
ax1.set_extent([165, 180,-48, -33])
ax1.quiver(lons1,lats1,0,north,color="b",width=0.003, scale=300,zorder=3)
