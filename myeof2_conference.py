...
east=pd.read_excel(os.path.join(path1,'location_conference_refined.xlsx'),usecols=['East'])
east=east.to_numpy()
...
yfinal1month= pd.read_excel(r'C:\Users\DELL\Desktop\SOP\sample2_conference.xlsx')
...
plt.title('Temporal Pattern(E)', fontsize=16)
plt.show()
...
ax1.set_extent([165, 180,-48, -33])
ax1.quiver(lons1,lats1,0,east,color="b",width=0.003,scale=250,zorder=3)
ax1.text(177.6,-46.6,'30 mm',fontsize=5)
plt.show()
